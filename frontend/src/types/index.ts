...
/**
 * The signed-in user's own saved profile (GET/PATCH /me) — the source
 * checkout pre-fills from. Distinct from `DeliveryDetails`: this has `email`
 * and no `note` (a delivery note is per-order, not part of the account).
 */
